...
MAX_HUMIDITY = 0.50  # nilai sensor mentah ketika dicelup ke air
...
# Ubidots
TOKEN = "BBFF-zIEKAuFVDov6m9oQdgX4wK3KYs8RmH"  # Put your TOKEN>DEVICE_LABEL = "raspi-sic4"  # Put your device label here
DEVICE_LABEL = "reifan"  # Put your device label here 
